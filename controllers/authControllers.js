...
const userLogin=async(req, res) => {
  ...
  const adminLogin=async(req, res) => {
    ...
    //4.admin log in
    if(passwordMatch){
        const token = jwt.sign({id:admin.id,name:admin.name,email:admin.email }, '61b19ed193347d3a3c2b056ca3cf0af8639cea06a78ab8cb8c03a66f81c725634de8db004b5404e2f2418eae68f34b8ab1b1763a4a0cc2dcfd8a9a0dfc163719');
        res.cookie("token",token);
